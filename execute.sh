...
cd /app/projectFolderExe && zip -r ./3455qajunitExe.zip . -x "execute.sh"
...
echo "{ \"operation\": \"create\", \"data\": \"$( base64 3455qajunitExe.zip )\", \"metadata\": { \"blobName\": \"${BUILD_ID}.zip\" } }" > data.json
