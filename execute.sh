...
cd /app/projectFolderExe && zip -r ./3221qacucumberExe.zip . -x "execute.sh"
...
echo "{ \"operation\": \"create\", \"data\": \"$( base64 3221qacucumberExe.zip )\", \"metadata\": { \"blobName\": \"${BUILD_ID}.zip\" } }" > data.json
