...
cd /app/projectFolderExe && zip -r ./3455qacucumberExe.zip . -x "execute.sh"
...
echo "{ \"operation\": \"create\", \"data\": \"$( base64 3455qacucumberExe.zip )\", \"metadata\": { \"blobName\": \"${BUILD_ID}.zip\" } }" > data.json
