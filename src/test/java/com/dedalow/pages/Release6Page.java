...
public class Release6Page {
	...
	public Release6Page ClickEmail(HashMap<String, String> variables) throws Exception {
        	driver.findElement(WriteEmail).clear();
                driver.findElement(WriteEmail).sendKeys(variables.get("BeforeEach"));
                Report.reportLog(reflectiveClass, "Typed " + variables.get("BeforeEach") + " in WriteEmail", "INFO", 0, Status.PASS, true, "", "", null);
	...
	public Release6Page ClickLastName(HashMap<String, String> variables) throws Exception {
        	driver.findElement(WriteLastName).clear();
                driver.findElement(WriteLastName).sendKeys(variables.get("BeforeEach"));
                Report.reportLog(reflectiveClass, "Typed " + variables.get("BeforeEach") + " in WriteLastName", "INFO", 0, Status.PASS, true, "", "", null);
	...
	public Release6Page ClickFirstName(HashMap<String, String> variables) throws Exception {
        	driver.findElement(WriteFirstName).clear();
                driver.findElement(WriteFirstName).sendKeys(variables.get("BeforeEach"));
                Report.reportLog(reflectiveClass, "Typed " + variables.get("BeforeEach") + " in WriteFirstName", "INFO", 0, Status.PASS, true, "", "", null);
