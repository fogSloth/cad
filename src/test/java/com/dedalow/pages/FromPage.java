...
public class FromPage {
	...
	public FromPage fillInputs1() throws Exception {
            ...
            Report.reportLog(dependencies, "Typed " + "a name in nameById1", "INFO", 0, Status.PASS, true, "", "", null);	dependencies.driver.findElement(lastNameByXpathAndDoubleQuote1).clear();
            dependencies.driver.findElement(lastNameByXpathAndDoubleQuote1).sendKeys("a last name");
            Report.reportLog(dependencies, "Typed " + "a last name in lastNameByXpathAndDoubleQuote1", "INFO", 0, Status.PASS, true, "", "", null);	dependencies.driver.findElement(emailByXpathAndSingleQuote1).clear();
            dependencies.driver.findElement(emailByXpathAndSingleQuote1).sendKeys("an email");
            Report.reportLog(dependencies, "Typed " + "an email in emailByXpathAndSingleQuote1", "INFO", 0, Status.PASS, true, "", "", null);	dependencies.driver.findElement(phoneByName1).clear();
