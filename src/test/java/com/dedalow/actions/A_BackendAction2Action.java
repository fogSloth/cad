...
public class A_BackendAction2Action {
	...
	public A_BackendAction2Action postPOST2() throws Exception {
            ...
            Report.reportLog(dependencies, "postPOST2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
	...
	public A_BackendAction2Action VerdictPost2() throws Exception {
        dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion12 check the Header return Content-Type: "
            + apiResponse.getHeader("Content-Type") + ", expected contains utf-8", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion12 check the Header <br><strong>return</strong> Content-Type: "  + apiResponse.getHeader("Content-Type")
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion13 check the Body return job: "
            + apiResponse.jsonPath().getString("job") + ", expected contains leader", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion13 check the Body <br><strong>return</strong> job: "  + apiResponse.jsonPath().getString("job")
        ...
        Report.reportLog(dependencies, "VerdictPost2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
        dependencies.isBackend = false;
        return this;
        }
		
	public A_BackendAction2Action getGET2() throws Exception {
            dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "getGET2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
            dependencies.isBackend = false;
            return this;
            }
	...
	public A_BackendAction2Action VerdictGet2() throws Exception {
        dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion14 check the Body return support: "
            + apiResponse.jsonPath().getString("support") + ", expected contains [text:To keep ReqRes free, contributions towards server costs are appreciated!, url:https://reqres.in/#support-heading]", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion14 check the Body <br><strong>return</strong> support: "  + apiResponse.jsonPath().getString("support")
        ...
        Report.reportLog(dependencies, "VerdictGet2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
        dependencies.isBackend = false;
        return this;
        }
		
	public A_BackendAction2Action patchPATCH2() throws Exception {
            dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "patchPATCH2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
            dependencies.isBackend = false;
            return this;
            }
	...
	public A_BackendAction2Action VerdictPatch2() throws Exception {
        dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion11 check the Body return updatedAt: "
            + apiResponse.jsonPath().getString("updatedAt") + ", expected contains 2022", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion11 check the Body <br><strong>return</strong> updatedAt: "  + apiResponse.jsonPath().getString("updatedAt")
        	...
        	+ apiResponse.getStatusCode() + " status code, </br><strong>expected</strong> 200", "backendAssertion", null);
        Report.reportLog(dependencies, "VerdictPatch2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
        dependencies.isBackend = false;
        return this;
        }
		
	public A_BackendAction2Action putPUT2() throws Exception {
            dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "putPUT2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
            dependencies.isBackend = false;
            return this;
            }
	...
	public A_BackendAction2Action VerdictPut2() throws Exception {
        dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion10 check the Body return job: "
            + apiResponse.jsonPath().getString("job") + ", expected notContains jesus", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion10 check the Body <br><strong>return</strong> job: "  + apiResponse.jsonPath().getString("job")
        	...
        	+ apiResponse.getStatusCode() + " status code, </br><strong>expected</strong> 200", "backendAssertion", null);
        Report.reportLog(dependencies, "VerdictPut2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
        dependencies.isBackend = false;
        return this;
        }
		
	public A_BackendAction2Action postErrorPOST2() throws Exception {
            dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "postErrorPOST2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
            dependencies.isBackend = false;
            return this;
            }
	...
	public A_BackendAction2Action VerdictPostError2() throws Exception {
        dependencies.isBackend = true;
        	...
        	+ apiResponse.getStatusCode() + " status code, </br><strong>expected</strong> 201", "backendAssertion", null);
        Report.reportLog(dependencies, "VerdictPostError2 action completed", "INFO", 0, Status.PASS, false, "", "", null);
        dependencies.isBackend = false;
        return this;
        }
		
	public A_BackendAction2Action postUriContextPOST() throws Exception {
            dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "postUriContextPOST action completed", "INFO", 0, Status.PASS, false, "", "", null);
            dependencies.isBackend = false;
            return this;
            }
